...
public final class BitmapUtil {
     ...
     * @return
     */
    public static Bitmap zhengfangxin(Bitmap bitmap){
    ...
    /**
     * @param bitmap 原图    * @param edgeLength  希望得到的正方形部分的边长    * @return  缩放截取正中部分后的位图。宽高比例10：7
     */
    public static Bitmap centerSquareScaleBitmap1(Bitmap bitmap, int edgeLength) {
        ...
        if (widthOrg > edgeLength && heightOrg > edgeLength) {
            ...
            int yTopLeft = (scaledHeight - edgeLength) / 2;
            try {
                result = Bitmap.createBitmap(scaledBitmap, xTopLeft, yTopLeft, edgeLength, (int)(edgeLength*0.7));
                scaledBitmap.recycle();
            } catch (Exception e) {
                return null;
            }
    ...
    /**
     * @param bitmap 原图    * @param edgeLength  希望得到的正方形部分的边长    * @return  缩放截取正中部分后的位图。宽高比例1:2
     */
    public static Bitmap centerSquareScaleBitmap2(Bitmap bitmap, int edgeLength) {
        ...
        if (widthOrg > edgeLength && heightOrg > edgeLength) {
            ...
            int yTopLeft = (scaledHeight - edgeLength) / 2;
            try {
                result = Bitmap.createBitmap(scaledBitmap, xTopLeft, yTopLeft, (int)(edgeLength*0.7), edgeLength);
                scaledBitmap.recycle();
            } catch (Exception e) {
                return null;
            }
     ...
     * @return 保存的路径
     */
    public static File saveBitmapToSD(Bitmap bitmap, File tempFile) {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
