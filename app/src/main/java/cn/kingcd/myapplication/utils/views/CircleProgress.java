...
/**
 * Created by lilingfei on 2016/10/22 0022.
 */
...
public class CircleProgress extends View {
    ...
    private int socktwidth = dp2px(5);// 圆环进度条的宽度
    private Paint paint = new Paint();
    private Rect rec = new Rect();
    private int value = 100;// 百分比0~100;
    private int textSize = dp2px(15);// 文字大小
    private Bitmap bitmap;
    @Deprecated
    float scale = 0.15f;// 中间背景图片相对圆环的大小的比例
    private int preColor = Color.parseColor("#E3E3E3");// 进度条未完成的颜色
    private int progressColor = Color.parseColor("#23bffc");// 进度条颜色
//    private float paddingscale = 0.8f;// 控件内偏距占空间本身的比例
private float paddingscale = 1f;// 控件内偏距占空间本身的比例
    private int CircleColor = Color.parseColor("#ECFFFF");// 圆中间的背景颜色
